...
negative = ['bad', 'trash','dislike']

#list of positive English words 
positive = ['good','nice','like']

#list of stop words 
stopwords =['is','that','this','the']
...
text_three = 'the design is good but the color is bad'
print('-----------text and polarity------------')
